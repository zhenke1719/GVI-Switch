...
{
    cout<<"frameCnt_for_initial ======================== "<<frameCnt<<endl;
    if(frameCnt > 0)
    {
...
void FeatureManager::triangulate(int frameCnt, Vector3d Ps[], Matrix3d Rs[], Vector3d tic[], Matrix3d ric[])
{
    for (auto &it_per_id : feature)
    {
        ...
        if(STEREO && it_per_id.feature_per_frame[0].is_stereo)//双目初始化深度
        {
            ...
            if (depth > 0)
            {
                it_per_id.estimated_depth = depth;// + 2.5
                // cout<<"local_depth = ==== = === = = ="<<depth<<endl;
            }
